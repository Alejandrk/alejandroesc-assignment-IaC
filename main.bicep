...
@minLength(3)
@maxLength(30)
param appServiceAppName1 string = 'alejandroesc-assignment-be-pr'
@sys.description('The Web App name.')
@minLength(3)
@maxLength(30)
param appServiceAppName3 string = 'alejandroesc-assignment-fe-pr'
@sys.description('The App Service Plan name.')
@minLength(3)
@maxLength(30)
param appServicePlanName1 string = 'alejandroesc-assignment-pr'
@sys.description('The Web App name.')
@minLength(3)
@maxLength(30)
param appServiceAppName2 string = 'alejandroesc-assignment-be-dv'
@minLength(3)
@maxLength(30)
param appServiceAppName4 string = 'alejandroesc-assignment-fe-dv'
@sys.description('The App Service Plan name.')
@minLength(3)
@maxLength(30)
param appServicePlanName2 string = 'alejandroesc-assignment-dv'
@allowed([
  'nonprod'
  'prod'
  ])
